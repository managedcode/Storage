...
public class BlobStream : Stream
{
    ...
    public BlobStream(string connectionString, string container, string fileName) : this(GetClient(connectionString, container, fileName))
    {
    }
    ...
    private long BlobLength => _pageBlob.GetProperties()
        .Value.ContentLength;
